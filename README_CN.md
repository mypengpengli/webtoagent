...
5. 如果开启“全自动发送”，网页 AI 的最新回复会自动转给 Claude Code。
6. 在过程抽屉里查看 Claude Code 的工具调用、命令输出和最终结果。
7. 结果可以手动发回网页 AI，也可以自动发回。
8. 点击 **停止** 可以暂停 Bridge。
