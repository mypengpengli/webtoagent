        ...
        <div class="aifr-bridge" id="bridge-panel">
          ...
          <div class="aifr-bridge-direct" style="margin-top:8px;">
            <div style="font-size:11px;color:#cba6f7;margin-bottom:4px;display:flex;align-items:center;gap:6px;">
              ...
              <span style="color:#6c7086;font-size:10px;">Enter 发送 / Shift+Enter 换行</span>
            </div>
  ...
  _getStyles() {
    return `
      .aifr-sidebar {
        ...
        border-left: 1px solid rgba(137, 180, 250, 0.12);
      ...
      .aifr-bridge-console {
        ...
        display: flex;
        flex-direction: column;
        box-shadow: -4px 0 24px rgba(0, 0, 0, 0.4), inset 1px 0 0 rgba(255, 255, 255, 0.03);
